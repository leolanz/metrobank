  ...
  return (
    <>
            ...
            {props?.channel === "BEN" ? (
              ...
              <div className="text">
                <h3 className="text-center">
                  Para abrir una cuenta nueva, necesitaras tu cedula de
                  identidad laminada
                </h3>
                <p className="text-center text-light">
                  Es muy facil. En 3 simples pasos podras abrir una cuenta
                  siendo nacional o extranjero.
                </p>
              </div>
            )}
          </div>
      ...
      <div className="landing-desk">
        <h4 className="title">
          Banco Nacional de Panamá, necesita permisos en tu navegador. Presiona
          para que puedas usar la cámara.
        </h4>
        <p className="text">
          Las fotos únicamente serán utilizadas para realizar el proceso
          Onboarding y solicitar la apertura de una cuenta.
        </p>

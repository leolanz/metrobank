    ...
    <>
      <div className="info-container">
            ...
            <>
              ...
              <div className="edit-row">
                <div className="content">
                  <p>Selfie</p>
                  <img src={require.selfieCache} alt="" className="img-preview" />
                </div>
                <div className="content-button">
                  <div
                    className={props?.channel === 'BEN' ? 'text-edit ben-color' : 'text-edit'}
                    onClick={() => {
                      setModal(false);
                      props?.goTo(0);
                    }}
              ...
              <div className="edit-row">
                <div className="content">
                  ...
                  <img src={require.documentCache} alt="" className="img-preview" />
                </div>
                <div className="content-button">
                  <div
                    className={props?.channel === 'BEN' ? 'text-edit ben-color' : 'text-edit'}
                ...
                <div className="edit-col">
                  <div className="content">
                    ...
                    <div className="img-wrapper">
                      <img src={require.selfie} alt="" className="img-preview" />
                      <span
                        className="text-edit"
                        onClick={() => {
                          setModal(false);
        ...
        {props?.channel === 'BEN' ? (
          ...
          <h3 className="title">Confirma que todos tus datos sean correctos.</h3>
        )}
